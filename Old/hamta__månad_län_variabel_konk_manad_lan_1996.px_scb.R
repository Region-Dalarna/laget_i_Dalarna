hamta__månad_län_variabel_scb <- function(
  ...
  #
  # Skapad av: frkjon den 26 september 2024
  ...
  url_uttag <- "https://statistik.tillvaxtanalys.se:443/PxWeb/api/v1/sv/Tillväxtanalys statistikdatabas/Konkurser och offentliga ackord/konk_manad_lan_1996.px"
  ...
  månad_vekt <- hamta_kod_med_klartext(px_meta, månad_klartext, skickad_fran_variabel = "månad")
