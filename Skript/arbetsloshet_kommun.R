...
hamta_data_arbetsloshet <- function(vald_region="20",
  ...
  arblosa_bakgr <- arblosa_bakgr %>% 
    mutate(grupp = ifelse(between(arbetslöshet,0,2),"0-2",
                          ifelse(between(arbetslöshet,2.001,4),"2-4",
                                 ifelse(between(arbetslöshet,4.001,6),"4-6",
                                        ifelse(between(arbetslöshet,6.001,8),"6-8",
                                               ifelse(between(arbetslöshet,8.001,10),"8-10",">10"))))))
