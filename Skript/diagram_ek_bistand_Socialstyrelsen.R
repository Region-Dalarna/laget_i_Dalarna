...
diagram_ek_bistand <- function(output_mapp = "G:/Samhällsanalys/Statistik/Näringsliv/basfakta/",
  ...
  # Uppdateras genom att hämta en ny version av data. Hämtad senaste 2024-03-11
  ekonomiskt_bistand_df <-  read.xlsx(here("Data","Socialstyrelsen 2024_03_11.xlsx"),startRow = 2) %>% 
