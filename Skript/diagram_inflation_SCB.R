#test = diagram_inflation_SCB(spara_figur=FALSE)
diagram_inflation_SCB <- function(output_mapp = "G:/Samhällsanalys/Statistik/Näringsliv/basfakta/",
  ...
  source("C:/Users/frkjon/Projekt/laget_i_Dalarna/Skript/hamta_KPIF_tid_KPIF_scb.R")
  source("https://raw.githubusercontent.com/Region-Dalarna/funktioner/main/func_SkapaDiagram.R", encoding = "utf-8")
  
  diagram_capt <- "Källa: SCB:s öppna statistikdatabas\nBearbetning: Samhällsanalys, Region Dalarna"
  gg_list <- list()
  
  KPIF_df <- hamta_KPIF_tid_scb(
    cont_klartext = "KPIF, 12-månadsförändring, 1987=100",			 #  Finns: "KPIF, index, 1987=100", "KPIF, månadsförändring, 1987=100", "KPIF, 12-månadsförändring, 1987=100"
  ...
  gg_obj <- SkapaLinjeDiagram(skickad_df = KPI_utskrift,
                                       ...
                                       manual_color = c(valda_farger,"#000000"),
