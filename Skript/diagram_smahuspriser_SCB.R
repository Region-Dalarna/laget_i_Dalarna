...
diagram_smahuspriser <- function(region_vekt = "20",
  ...
  # Länk till tabell: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__BO__BO0501__BO0501B/SmahusT2M/
  smahuspriser_df <- pxweb2_hamta_data(
    tabell = "TAB3656",
    query = list(
      Region = hamtaAllaLan(),
      ContentsCode = "Medelpris, 1000-tals kronor",
      Tid = "*"
    )) %>% 
    rename(`Medelpris, 1000-tals kronor` = value,
