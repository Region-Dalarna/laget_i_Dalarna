hamta_andel_utrikes_region_alder_kon_fodelseregion_tid_scb <- function(
			...
			excel_filnamn = "andel_utrikes.xlsx",			# filnamn för excelfil som exporteras om excel_filnamn och output_mapp anges
  ...
  #
  # Skapad av: frkjon den 04 juni 2024
