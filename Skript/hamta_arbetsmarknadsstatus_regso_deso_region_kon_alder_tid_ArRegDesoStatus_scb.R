hamta_arbetsmarknadsstatus_regso_deso_region_kon_alder_tid_scb <- function(
			region_vekt = "20",			   # Val av region. Finns antingen län, kommun eller Regso/Deso. Vid län/kommun får man alla regso/deso för länet/kommuner. Exempel "0114A0010", "0114C1010", "0114R001", "0114R002", "2584C1110", "2584C1130", "2584R014", "2584R015"
			...
			region_indelning = "regso", # Finns även deso
			long_format = TRUE,			# TRUE = konvertera innehållsvariablerna i datasetet till long-format 
			wide_om_en_contvar = TRUE,			# TRUE = om man vill behålla wide-format om det bara finns en innehållsvariabel, FALSE om man vill konvertera till long-format även om det bara finns en innehållsvariabel
			output_mapp = NA,			# anges om man vill exportera en excelfil med uttaget, den mapp man vill spara excelfilen till
			excel_filnamn = "arbetsmarknadsstatus_regso_deso.xlsx",			# filnamn för excelfil som exporteras om excel_filnamn och output_mapp anges
  ...
  #
  # Skapad av: frkjon den 15 oktober 2025
  # Senast uppdaterad: 15 oktober 2025
  #
  # url till tabellens API: https://api.scb.se/OV0104/v1/doris/sv/ssd/START/AM/AM0210/AM0210G/ArRegDesoStatus
  #
  # ====================================================================================================
