hamta_flyttnetto_procent_region_bakgrund_tid_scb <- function(
  ...
  #
  # Skapad av: frkjon den 09 oktober 2025
  # Senast uppdaterad: 09 oktober 2025
  #
  # url till tabellens API: https://www.statistikdatabasen.scb.se/pxweb/sv/ssd/START__AA__AA0003__AA0003C/IntGr2Kom/
  #
  # ====================================================================================================
  ...
  # Url till databas
  url_uttag <- "https://api.scb.se/OV0104/v1/doris/sv/ssd/START/AA/AA0003/AA0003C/IntGr2Kom"
