hamta_nystartade_bransch_kvartal_lan_bransch_variabel_tva <- function(
			...
			bransch_klartext = "*",			 #  Finns: "SNI 01-03 Jordbruk, skogsbruk och fiske", "SNI 05-39 Tillverkning och dylikt", "SNI 41-43 Bygg och anläggning", "SNI 45 Handel med samt reparation av motorfordon", "SNI 46 Parti- och provisionshandel utom med motorfordon", "SNI 47 Detaljhandel utom med motorfordon", "SNI 49-53 Transport och magasinering", "SNI 55 Hotell- och logiverksamhet", "SNI 56 Restaurang-, catering och barverksamhet", "SNI 58-61 Förlag, radio, TV, film och telekommunikation", "SNI 62-63 Programmering och informationstjï¿½nster", "SNI 64-68 Finans-, försäkrings- och fastighetsverksamhet", "SNI 69-70 Juridisk- och ekonomisk konsultverksamhet", "SNI 71-72 Arkitekt-, teknisk konsultverksamhet och forskning", "SNI 73 Reklam och marknadsföring", "SNI 74-75 Annan specialiserad konsultverksamhet och veterinärtjänster", "SNI 77-82 Uthyrning, personalförmedling, turism, bevakning samt andra kontorstjänster", "SNI 85 Utbildning", "SNI 86-88 Vård och omsorg", "SNI 90-93 Kultur, nöje och fritid", "SNI 94-99 Andra serviceföretag och personliga tjänster", "X Bransch ospecificerad"
  ...
  #
  # url till tabellens API: https://statistik.tillvaxtanalys.se:443/PxWeb/api/v1/sv/Tillväxtanalys statistikdatabas/Nystartade företag/nyaf_kvartal_lan_bransch_2011.px
  #
  # ====================================================================================================
  ...
  url_uttag <- "https://statistik.tillvaxtanalys.se:443:443/PxWeb/api/v1/sv/Tillväxtanalys statistikdatabas/Nystartade företag/nyaf_kvartal_lan_bransch_2011.px"
  ...
  bransch_vekt <- hamta_kod_med_klartext(px_meta, bransch_klartext, skickad_fran_variabel = "bransch")
