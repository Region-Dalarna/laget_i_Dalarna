...
<ul>
<li> Inflationen har gått ned och hushållen och företagens syn på ekonomin har förbättrats på sistone, samtidigt som aktiviteten i ekonomin (BNP) ökade under det senaste kvartalet. </li>
<li> Bostadsmarknaden i Dalarna har upplevt en nedgång i både bygglov, nybyggnation och bostadspriser sedan 2022, men bostadspriserna har återhämtat sig något de senaste månaderna. Dessutom ökade såväl bygglov för, som nybyggnation av, lägenheter markant första kvartalet 2024. </li>
<li> Antalet anställda berörda av konkurser i Dalarna har ökat mellan januari och maj 2024, jämfört med samma period året innan. </li>
...
Den bransch som drabbades värst av konkurser i `r last(konkurser_df$manad_long)` `r unique(konkurser_branscher_df$år)` var "`r konkurser_branscher_df %>% filter(varde==max(varde)) %>% .$bransch`", där `r konkurser_branscher_df %>% filter(varde==max(varde)) %>% .$varde` personer berördes av konkurser. Detta är sannolikt en följd av att företag i byggbranschen har drabbats extra hårt av stigande kostnader till följd av materialbrist och höga räntor ([SCB](https://www.scb.se/pressmeddelande/jobb-i-byggbranschen-drabbas-av-nedgang-i-ekonomin/){target="_blank"}). Även inom "Hotell och restauranger" drabbades relativt många av konkurser.
