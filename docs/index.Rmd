...
<ul>
<li> Konjunkturinstitutets barometerindikator visar på ett normalt stämningsläget i den svenska ekonomin i `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar`. Aktiviteten i ekonomin (BNP) ökade dessutom under det fjärde kvartalet 2025.</li>
...
### Generellt {-}
I `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar` var barometerindikatorn `r konjukturbarometern_senaste_varde`, vilket var i stort sett oförändrat jämfört med månaden innan. Barometerindikatorn visar på ett normalt stämningsläge i den svenska ekonomin (se [Konjunkturinstitutet](https://www.konj.se/publikationer/konjunkturbarometern/2026-03-25-fortsatt-normaltstarkt-stamningslage/){target="_blank"}) . Att barometerindikatorn länge hade ett lågt värde kan delvis förklaras av Rysslands invasion av Ukraina och de effekter denna haft på bland annat tillgången på råvaror. Historiskt varierar barometerindikatorn med konjunkturen och större kriser i samhället, såsom finanskrisen 2008/2009 och Coronapandemin 2020/2021, syns tydligt i diagrammet.
...
Under stora delar av 2025 var arbetslösheten i Dalarna på ungefär samma nivå som motsvarande perioder 2023 och 2024, men mot slutet av året var den något lägre. Denna trend fortsatte i januari 2026, då arbetslösheten var lägre än motsvarande månader åren innan.

```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.height=5, fig.width=8, fig.align='center'}
gg_arbetsloshet_tidsserie$arbetslöshet_tidsserie_totalt_Dalarna
```

Om arbetslösheten delas upp i inrikes och utrikes födda framträder en delvis annorlunda bild. Bland inrikes födda (det vänstra diagrammet nedan) var arbetslösheten något högre under 2025 jämfört med åren innan under stora delar av året . I `r arbetsloshet_tidsserie_manad` `r arbetsloshet_tidsserie_ar` var arbetslösheten bland inrikes födda `r arbetsloshet_tidserie_Dalarna_inrikes_varde` procent i Dalarna, vilket dock var lägre än motsvarande månad året innan (men högre än 2024 och 2023). Bland utrikes födda (det högra diagrammet nedan) har arbetslösheten fortsatt att minska stadigt under samma tidsperiod, men är klart högre än bland inrikes födda (`r arbetsloshet_tidserie_Dalarna_utrikes_varde` procent i `r arbetsloshet_tidsserie_manad` `r arbetsloshet_tidsserie_ar`). 
