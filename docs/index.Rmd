...
Antalet personer som har ekonomiskt stöd som huvudsaklig inkomstkälla varierar en del mellan månaderna, men under 2024 var trenden nedåtgående jämfört med föregående år. I `r ek_stod_manad_ar_sista` hade `r ek_stod_totalt_sista` personer ekonomiskt stöd som huvudsaklig inkomstkälla, vilket var fler än månaden innan men färre än samma månad föregående år.
