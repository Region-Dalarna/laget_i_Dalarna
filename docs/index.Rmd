...
<ul>
<li> Konjunkturinstitutets barometerindikator visar på ett normalt stämningsläget i den svenska ekonomin i `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar`. Stämningsläget bland hushållen försämrades dock jämfört med månaden innan och är fortsatt svagare än normalt.</li>
...
<li> Priserna på småhus i Dalarna var något högre i `r priser_senaste_manad_ar `, jämfört med månaden innan.
<li> Antalet anställda berörda av konkurser i Dalarna ökade i `r konkurser_senaste_manad` `r konkurser_senaste_ar`, jämfört med motsvarande månad åren innan. </li>
<li> Arbetslösheten i Dalarna, som är klart under genomsnittet i Sverige, var lägre i januari 2026, jämfört med motsvarande månader åren innan.</li>
...
Konjunkturinstitutet sammanställer på sin [hemsida](https://www.konj.se/publikationer/prognosjamforelse/){target="_blank"} ett urval av aktuella prognoser för bland annat BNP (på helårsbasis). För år 2026 är den allmänna uppfattningen bland prognosinstituten att aktiviteten i Sveriges ekonomi (BNP) kommer att öka med mellan 2,5 och 3 procent. Året efter är prognoserna något lägre, en tillväxt i BNP på mellan 2 och 2,5 procent.
...
### Generellt {-}
I `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar` var barometerindikatorn `r konjukturbarometern_senaste_varde`, vilket var i stort sett oförändrat jämfört med månaden innan. Barometerindikatorn visar på ett normalt stämningsläge i den svenska ekonomin (se [Konjunkturinstitutet](https://www.konj.se/publikationer/konjunkturbarometern/2026-04-29-normalt-stamningslage-men-mer-pessimistiska-hushall/){target="_blank"}). 
...
Hur läget i ekonomin uppfattas varierar beroende på om det är företagen eller hushållen som tillfrågas. Hushållens syn på ekonomin försämrades i `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar`, jämfört med månaden innan (en barometerindikator på `r konj_hushall_senaste`). Eftersom indikatorn understiger 100, är stämningsläget bland hushållen sämre än normalt, (se [Konjunkturinstitutet](https://www.konj.se/publikationer/konjunkturbarometern/2026-04-29-normalt-stamningslage-men-mer-pessimistiska-hushall/){target="_blank"}). 

Bland branschgrupperna i diagrammet nedan hade `r konj_bransch_positiv` den mest positiva synen på ekonomin i `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar` (en barometerindikator på `r konj_bransch_positiv_varde`), medan företag inom de övriga branschgrupperna uppfattar den ekonomiska utvecklingen som mer normal, se [Konjunkturinstitutet](https://www.konj.se/publikationer/konjunkturbarometern/2026-04-29-normalt-stamningslage-men-mer-pessimistiska-hushall/){target="_blank"}).
...
Sedan Riksbankens inflationsmål infördes 1993 har inflationen, mätt som årsförändring i KPIF, legat klart under inflationsmålet på 2 procent under långa perioder. Från sin bottennivå i april 2020 ökade dock inflationen väldigt mycket och var som högst i `r inflation_max_manad_ar`, då den i Sverige uppgick till `r inflation_max_varde` procent. Därefter minskade inflationen avsevärt och var som lägst i september 2024 (1,1 procent). I  `r inflation_senaste_manad_ar` var inflationen `r inflation_senaste_varde` procent, vilket var lägre än månaden innan och även lägre än Riksbankens inflationsmål på 2 procent. För en mer ingående förklaring av vad som påverkade inflationstakten i `r inflation_senaste_manad_ar`, se [SCB](https://www.scb.se/hitta-statistik/statistik-efter-amne/priser-och-ekonomiska-tendenser/priser/konsumentprisindex-kpi/pong/statistiknyhet/konsumentprisindex-kpi-mars-2026/){target="_blank"}. Riksbankschefen Erik Thedéen varnar dock för att högre drivmedelspriser till följd av kriget i Mellanöstern kan leda till en ökad inflation ([Riksbanken](https://www.riksbank.se/sv/press-och-publicerat/nyheter-och-pressmeddelanden/nyheter/2026/thedeen-buffertar-ska-vara-anvandbara/){target="_blank"}).
...
### Nybyggnation {-}
Precis som för byggloven, varierar byggandet av småhus mellan kvartalen, men en långsiktig trend är att byggandet har minskat tydligt från toppen i  `r husbyggande_smahus_max_manad_ar`, då `r husbyggande_smahus_max_varde` småhus påbörjades, till  `r husbyggande_smahus_senaste_manad_ar`, då `r husbyggande_smahus_senaste_varde` småhus påbörjades. Notera dock att det finns en eftersläpning i statistiken, se "Mer information om statistiken" ovan.
...
Sedan 2023 har priserna på småhus i Dalarna delvis återhämtat sig och var i `r priser_senaste_manad_ar ` drygt `r priser_senaste_varde` miljoner kronor (i genomsnitt), vilket var högre än månaderna innan.
...
### Län {-}
Det genomsnittliga priset på ett småhus varierar mellan Sveriges län och var i `r priser_senaste_manad_ar` högst i `r priser_senaste_max_region`, där ett småhus i genomsnitt kostade `r priser_senaste_max_varde` miljoner kronor. I Dalarna är priset klart lägre, ett småhus kostar i genomsnitt drygt `r priser_senaste_varde` miljoner kronor i länet. Av förklarliga skäl är bostadspriserna generellt högst i län med större städer där befolkningen växer, medan det omvända gäller för län med en mindre befolkning.
...
I `r konkurser_senaste_manad` `r konkurser_senaste_ar` berördes `r konkurser_senaste_antal` anställda av konkurser, vilket var klart `r ifelse(konkurser_senaste_antal > konkurser_foregaende_ar_antal,"fler","färre")` än de `r konkurser_foregaende_ar_antal` anställda som berördes motsvarande månad `r konkurser_foregaende_ar`.
...
Under stora delar av 2025 var arbetslösheten i Dalarna på ungefär samma nivå som motsvarande perioder 2023 och 2024, men mot slutet av året var den något lägre. Denna trend fortsatte i januari och februari 2026, då arbetslösheten varit lägre än motsvarande månader åren innan.
