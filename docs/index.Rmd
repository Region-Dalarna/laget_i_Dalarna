...
<ul>
<li> Hushållens syn på ekonomin har försämrats jämfört med inledningen av 2025, men aktiviteten i ekonomin (BNP) ökade under årets andra kvartal. </li>
...
Hur läget i ekonomin uppfattas varierar beroende på om det är företagen eller hushållen som tillfrågas. Hushållens syn på ekonomin har förbättrats de senaste månaderna, jämfört med månaderna innan, med en barometerindikator på `r konj_hushall_senaste` i `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar`. Hushållens syn på ekonomin är dock fortfarande sämre jämfört med inledningen av året (i februari 2025 var motsvarande siffra 94,5). Försämringen jämfört med inledningen av året hänger sannolikt samman med den osäkra situationen i omvärlden, med bland annat högre tullar för varor som exporteras till USA. 
...
På senare tid har byggindustri varit den bransch som uppfattat ekonomin som svagast, men jämfört med inledningen av året har synen på ekonomin inom branschen förbättrats. I `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar` var barometerindikatorn för byggindustri `r konj_bygg_senaste_varde`.
...
Sedan sommaren 2024 har Riksbanken sänkt sin styrränta sju gånger (den ligger nu på 2 procent). Detta påverkar [räntorna](https://www.scb.se/hitta-statistik/statistik-efter-amne/finansmarknad/finansmarknadsstatistik/finansmarknadsstatistik/pong/statistiknyhet/finansmarknadsstatistik-september-2024/){target="_blank"} på exempelvis bostadslån. I jämförelse med det senaste dryga decenniet är dock styrräntan fortfarande hög (se exempelvis [Ekonomifakta](https://www.ekonomifakta.se/sakomraden/finansiell-ekonomi/inflation-och-styrrantor/styrrantan_1208883.html){target="_blank"}). En majoritet (`r vanligaste_antal` av `r prognos_styrranta_antal_institut `) av de prognosinstitut som Konjunkturinstitutet följer på sin [hemsida](https://www.konj.se/publikationer/prognosjamforelse){target="_blank"} räknar med att styrräntan kommer att sänkas en gång till under `r prognos_styrranta_ar`, till `r vanligaste_varde` procent.
