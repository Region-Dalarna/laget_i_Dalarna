...
<ul>
<li> Hushållens syn på ekonomin har tydligt förbättrats de senaste månaderna. Dessutom ökade aktiviteten i ekonomin (BNP) under årets tredje kvartal. </li>
<li> Inflationen i oktober 2025 var på samma nivå som månaden innan, men är över Riksbankens inflationsmål.</li>
...
Hur läget i ekonomin uppfattas varierar beroende på om det är företagen eller hushållen som tillfrågas. Efter att ha förbättrats tydligt de senaste månaderna, försämrades hushållens syn på ekonomin något i `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar`, jämfört med månaden innan (en barometerindikator på `r konj_hushall_senaste`). Eftersom indikatorn understiger 100, är stämningsläget bland hushållen sämre än normalt. 
...
Sedan Riksbankens inflationsmål infördes 1993 har inflationen, mätt som årsförändring i KPIF, legat klart under inflationsmålet på 2 procent under långa perioder. Från sin bottennivå i april 2020 ökade dock inflationen väldigt mycket och var som högst i `r inflation_max_manad_ar`, då den i Sverige uppgick till `r inflation_max_varde` procent. Därefter minskade inflationen avsevärt och var som lägst i september 2024 (1,1 procent). I  `r inflation_senaste_manad_ar` var inflationen `r inflation_senaste_varde` procent, vilket var i linje med månaden innan men högre än Riksbankens inflationsmål på 2 procent. För en mer ingående förklaring av vad som påverkade inflationstakten i `r inflation_senaste_manad_ar`, se [SCB](https://www.scb.se/hitta-statistik/statistik-efter-amne/priser-och-ekonomiska-tendenser/priser/konsumentprisindex-kpi/pong/statistiknyhet/konsumentprisindex-kpi-oktober-2025/){target="_blank"}. 
...
Sedan 2023 har priserna på småhus i Dalarna delvis återhämtat sig och var i `r priser_senaste_manad_ar ` ungefär `r priser_senaste_varde` miljoner kronor (i genomsnitt), vilket dock var något lägre än månaden innan.
