...
Intressant att notera är att samtliga branschgrupper uppfattade ekonomin som starkare än normalt (ett indikatorvärde över 100) i `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar`. 
...
Sedan 2023 har priserna på småhus återhämtat sig delvis. I `r priser_senaste_manad_ar ` var priset på ett småhus ungefär `r priser_senaste_varde` miljoner kronor (i genomsnitt), vilket dock var något lägre än månaden innan.
