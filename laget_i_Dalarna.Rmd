...
<br>
Syftet med den här rapporten är att göra kvartalsvisa uppdateringar av läget i Dalarna. Fokus ligger i första hand på områden som rör Dalarnas ekonomi, såsom arbetsmarknad och bostadsbyggande, men initialt kommer vi även att diskutera läget i Sverige i stort. Detta eftersom vissa variabler, exempelvis konjunkturbarometern och inflation, bara mäts på nationell nivå, men ändå är relevanta för Dalarna som län. I de flesta fall uppdateras data antingen varje månad eller varje kvartal, men i vissa undantagsfall (arbetslöshet exempelvis) uppdateras data enbart årligen.
<br>

## Det allmänna läget i Ekonomin
<br>
Att beskriva läget i ekonomin kan göras på flera sätt. I detta första avsnitt har vi valt att fokusera på tre variabler som antingen bara mäts på nationell nivå (konjunkturbarometern och inflation) eller publiceras med relativt lång fördröjning regionalt (BNP).  
