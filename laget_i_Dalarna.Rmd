...
<ul>
<li> Hushållens syn på ekonomin har tydligt förbättrats de senaste månaderna. Dessutom ökade aktiviteten i ekonomin (BNP) under årets andra kvartal. </li>
<li>Inflationen i september 2025 var något lägre än månaden innan, men är över Riksbankens inflationsmål.</li>
<li> Priserna på småhus i Dalarna ökade tydligt i `r priser_senaste_manad_ar `, jämfört med månaderna innan.
...
### Generellt {-}
I `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar` var barometerindikatorn `r konjukturbarometern_senaste_varde`, vilket var en tydlig förbättring jämfört med månaderna innan. Det var även första gången sedan sommaren 2022 som barometerindikatorn överstigit 100 och läget i Sveriges ekonomi kan därför beskrivas som starkare än normalt. Att barometerindikatorn länge hade ett lågt värde kan delvis förklaras av Rysslands invasion av Ukraina och de effekter denna haft på bland annat tillgången på råvaror. Historiskt varierar barometerindikatorn med konjunkturen och större kriser i samhället, såsom finanskrisen 2008/2009 och Coronapandemin 2020/2021, syns tydligt i diagrammet.
...
Hur läget i ekonomin uppfattas varierar beroende på om det är företagen eller hushållen som tillfrågas. Hushållens syn på ekonomin har tydligt förbättrats de senaste månaderna, jämfört med månaderna innan, med en barometerindikator på `r konj_hushall_senaste` i `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar`. Eftersom barometerindikatorn understiger 100, är stämningsläget bland hushållen dock sämre än normalt. Enligt Konjunkturinstitutet hängder det samman med att hushållen är fortsatt negativt inställda till kapitalvaruinköp [(Konjunkturinstitutet)](https://www.konj.se/publikationer/konjunkturbarometern/2025-10-30-konjunkturbarometern-visar-pa-normaliserat-stamningslage/){target="_blank"}.
...
Även om om byggindustri var den bransch som uppfattade ekonomin som svagast i `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar`,  har synen på ekonomin inom branschen tydligt förbättrats jämfört med slutet av 2024. I `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar` var barometerindikatorn för byggindustri `r konj_bygg_senaste_varde`, att jämföra med ungefär 90 i december 2024.
...
Sedan Riksbankens inflationsmål infördes 1993 har inflationen, mätt som årsförändring i KPIF, legat klart under inflationsmålet på 2 procent under långa perioder. Från sin bottennivå i april 2020 ökade dock inflationen väldigt mycket och var som högst i `r inflation_max_manad_ar`, då den i Sverige uppgick till `r inflation_max_varde` procent. Därefter minskade inflationen avsevärt och var som lägst i september 2024 (1,1 procent). I  `r inflation_senaste_manad_ar` var inflationen `r inflation_senaste_varde` procent, vilket var något lägre än månaden innan men högre än Riksbankens inflationsmål på 2 procent. För en mer ingående förklaring av vad som påverkade inflationstakten i `r inflation_senaste_manad_ar`, se [SCB](https://www.scb.se/hitta-statistik/statistik-efter-amne/priser-och-ekonomiska-tendenser/priser/konsumentprisindex-kpi/pong/statistiknyhet/konsumentprisindex-kpi-september-2025/){target="_blank"}. 
...
### Nybyggnation {-}
Precis som för byggloven, varierar byggandet av småhus mellan kvartalen, men en långsiktig trend är att byggandet har minskat tydligt från toppen i  `r husbyggande_smahus_max_manad_ar`, då `r husbyggande_smahus_max_varde` småhus påbörjades, till botten under första kvartalet 2024, då blott 17 småhus påbörjades. I `r husbyggande_smahus_senaste_manad_ar` påbörjades `r husbyggande_smahus_senaste_varde` småhus, vilket var fler än kvartalet innan. Notera att det finns en eftersläpning i statistiken, se "Mer information om statistiken" ovan.
...
Under första halvåret 2024 steg priserna på småhus tydligt i Dalarna, innan de återigen började sjunka i augusti. I `r priser_senaste_manad_ar ` var priset på ett småhus ungefär `r priser_senaste_varde` miljoner kronor (i genomsnitt), vilket var en tydlig ökning jämfört med månaderna innan.
...
mapp_scbadmgranser <- "G:/Samhällsanalys/GIS/data/grundkartor/KommunerDalarna/"
