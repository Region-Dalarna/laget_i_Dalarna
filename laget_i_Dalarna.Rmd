...
# barometern_df[substr(barometern_df$Period,6,7)==last(substr(barometern_df$Period,6,7)),]
  ...
  diagramtitel <- paste0("Barometerindikatorn mellan ",first(barometern_df$manad_long)," ",first(barometern_df$ar)," och ",last(barometern_df$manad_long)," ",last(barometern_df$ar))
