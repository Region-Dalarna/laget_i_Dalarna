...
<li>Inflationen ökade i augusti 2025, jämfört med månaden innan, och är över Riksbankens inflationsmål.</li>
<li> Priserna på småhus i Dalarna ökade något i `r priser_senaste_manad_ar `, jämfört med månaden innan, men är fortfarande lägre än månaderna dessförinnan.
...
Konjunkturinstitutet sammanställer på sin [hemsida](https://www.konj.se/publikationer/prognosjamforelse/){target="_blank"} ett urval av aktuella prognoser för bland annat BNP (på helårsbasis). För år 2025 tror en majoritet av prognosinstituten att aktiviteten i Sveriges ekonomi (BNP) kommer att öka med runt 1 procent, vilket är en relativt låg tillväxt historiskt. Året efter är bilden av Sveriges ekonomi dock klart ljusare och de flesta prognosinstitut tror att BNP kommer att växa med mellan 2 och 3 procent under 2026.
...
Konjunkturinstitutet sammanställer även på sin [hemsida](https://www.konj.se/publikationer/prognosjamforelse/){target="_blank"} ett urval av aktuella prognoser för inflation (enligt KPIF). För år 2025 tror de allra flesta av prognosinstituten att inflationen enligt KPIF kommer att vara runt 2,5 procent, vilket är något under nivån i september 2025. Året efter är prognoserna över inflationen mer spretiga, men de flesta prognosinstitut prognostiserar en inflation på mellan 1 och 2 procent, dvs något under Riksbankens inflationsmål.
...
### Bygglov {-}
Antalet godkända bygglov för småhus i Dalarna varierar mellan kvartalen, men sedan toppen i  `r bygglov_smahus_max_manad_ar`, då `r  bygglov_smahus_max_varde` bygglov godkändes, har antalet godkända bygglov minskat och i `r bygglov_smahus_senaste_manad_ar`, godkändes `r bygglov_smahus_senaste_varde` bygglov. 
...
### Län {-}
Det genomsnittliga priset på ett småhus varierar mellan Sveriges län och var i `r priser_senaste_manad_ar` högst i `r priser_senaste_max_region`, där ett småhus i genomsnitt kostade `r priser_senaste_max_varde` miljoner kronor. I Dalarna är priset klart lägre, ett småhus kostade i genomsnitt ungefär `r priser_senaste_varde` miljoner kronor i länet. Av förklarliga skäl är bostadspriserna generellt högst i län med större städer där befolkningen växer, medan det omvända gäller för län med en mindre befolkning.
