...
Antalet personer som får stöd varierar en del mellan månaderna, men under 2024 har trenden varit nedåtgående då färre får ekonomiskt stöd jämfört med föregående år. I `r last(ekonomiskt_bistand_SCB_df$månad_år)` var `r last(ekonomiskt_bistand_SCB_df$antal)` personer i behov av sådant stöd.
