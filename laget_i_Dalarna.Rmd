...
<li> Antalet anställda berörda av konkurser i Dalarna minskade i `r konkurser_senaste_manad` `r konkurser_senaste_ar`, jämfört med motsvarande månad åren innan. </li>
...
Sedan 2023 har priserna på småhus i Dalarna delvis återhämtat sig och var i `r priser_senaste_manad_ar ` ungefär `r priser_senaste_varde` miljoner kronor (i genomsnitt), vilket var något högre än månaden innan.
...
I `r konkurser_senaste_manad` `r konkurser_senaste_ar` berördes `r konkurser_senaste_antal` anställda av konkurser, vilket dock var `r ifelse(konkurser_senaste_antal > konkurser_foregaende_ar_antal,"fler","färre")` än de `r konkurser_foregaende_ar_antal` anställda som berördes motsvarande månad `r konkurser_foregaende_ar`.
