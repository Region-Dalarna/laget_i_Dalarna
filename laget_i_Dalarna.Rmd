...
### Generellt {-}
I `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar` var barometerindikatorn `r konjukturbarometern_senaste_varde`, vilket var bättre än månaden innan men sämre än månaderna dessförrinnan. Eftersom barometerindikatorn understiger 100, kan läget beskrivas som svagare än normalt. Att barometerindikatorn länge hade ett lågt värde kan delvis förklaras av Rysslands invasion av Ukraina och de effekter denna haft på bland annat tillgången på råvaror. Historiskt varierar barometerindikatorn med konjunkturen och större kriser i samhället, såsom finanskrisen 2008/2009 och Coronapandemin 2020/2021, syns tydligt i diagrammet.
...
Hur läget i ekonomin uppfattas varierar beroende på om det är företagen eller hushållen som tillfrågas. Hushållens syn på ekonomin förbättrades tydlig i juli 2025, jämfört med månaderna innan, med en barometerindikator på `r konj_hushall_senaste` i `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar`. Hushållens syn på ekonomin är dock fortfarande sämre jämfört med inledningen av året (så sent som i februari 2025 var motsvarande siffra 94,5). Försämringen jämfört med inledningen av året hänger sannolikt samman med den osäkra situationen i omvärlden, med bland annat högre tullar för varor som exporteras till USA. 
