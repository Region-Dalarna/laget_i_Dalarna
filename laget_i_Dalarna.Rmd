...
arbetsloshet_kommun_min_varde <- gsub("\\.",",",arbetsloshet_kommun %>% filter(månad==max(månad)) %>%  filter(arbetslöshet==min(arbetslöshet)) %>% .$arbetslöshet %>% formatC(format = "f", digits = 1) %>%first())
...
arbetsloshet_kommun_max_varde <- gsub("\\.",",",arbetsloshet_kommun %>% filter(månad==max(månad)) %>%  filter(arbetslöshet==max(arbetslöshet)) %>% .$arbetslöshet %>% formatC(format = "f", digits = 1) %>% first()) 
