...
Antalet personer som får stöd varierar en del mellan månaderna, men under 2024 var trenden nedåtgående då färre fick ekonomiskt stöd jämfört med föregående år. I `r last(ekonomiskt_bistand_SCB_df$månad_år)` ökade dock antalet personer i behov av sådant stöd till `r last(ekonomiskt_bistand_SCB_df$antal)` personer, den högsta siffran sedan sommaren 2024.

```{r, echo = FALSE, message = FALSE, warning = FALSE, fig.height=5, fig.width=8, fig.align='center'}
gg_ek_bistand_SCB$ekonomiskt_bistand_individ_Dalarna
```

Om antalet individer som får ekonomiskt stöd delas upp i inrikes och utrikes födda, blir det tydligt att nedgången i antalet individer som får stöd framförallt är koncentrerad till utrikes födda. I `r first(ekonomiskt_bistand_bakgrund_SCB_df$månad_år)` var det `r ekonomiskt_bistand_bakgrund_SCB_df %>% filter(månad_år==first(månad_år)) %>% filter(födelseregion=="utrikes född") %>% .$antal - ekonomiskt_bistand_bakgrund_SCB_df %>% filter(månad_år==first(månad_år)) %>% filter(födelseregion=="inrikes född") %>% .$antal ` fler utrikes födda personer som var i behov av ekonomiskt stöd i Dalarna, jämfört med inrikes födda. I `r last(ekonomiskt_bistand_bakgrund_SCB_df$månad_år)` var den skillnaden bara `r ekonomiskt_bistand_bakgrund_SCB_df %>% filter(månad_år==last(månad_år)) %>% filter(födelseregion=="utrikes född") %>% .$antal - ekonomiskt_bistand_bakgrund_SCB_df %>% filter(månad_år==last(månad_år)) %>% filter(födelseregion=="inrikes född") %>% .$antal ` personer.
