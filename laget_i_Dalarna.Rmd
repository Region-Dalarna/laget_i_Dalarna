...
<li> Bostadsmarknaden i Dalarna har upplevt en nedgång i både bygglov, nybyggnation och bostadspriser sedan 2022, men bostadspriserna har återhämtat sig något de senaste månaderna. Dessutom ökade såväl bygglov för, som nybyggnation av, flerbostadshus tydligt första kvartalet 2024. </li>
<li> Antalet anställda berörda av konkurser i Dalarna har ökat tydligt mellan januari och maj 2024, jämfört med samma period året innan. </li>
...
Den bransch som drabbades värst av konkurser i `r last(konkurser_df$manad_long)` `r unique(konkurser_branscher_df$år)` var "`r konkurser_branscher_df %>% filter(varde==max(varde)) %>% .$bransch`", där `r konkurser_branscher_df %>% filter(varde==max(varde)) %>% .$varde` personer berördes av konkurser. Även inom "Hotell och restauranger" drabbades relativt många av konkurser.
