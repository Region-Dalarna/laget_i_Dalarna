...
<li> Priserna på småhus i Dalarna har ökat något på sistone, men är fortfarande lägre än de höga nivåerna under inledningen av 2022.
...
Konjunkturinstitutet sammanställer på sin [hemsida](https://www.konj.se/publikationer/prognosjamforelse/){target="_blank"} ett urval av aktuella prognoser för bland annat BNP (på helårsbasis). För år 2026 tror prognosinstituten i genomsnitt på en ökning av aktiviteten i Sveriges ekonomi (BNP) på ungefär `r prognos_BNP_2026` procent, medan förväntningarna år 2027 är något högre (en ökning med cirka `r prognos_BNP_2027` procent). 
...
I `r konkurser_senaste_manad` `r konkurser_senaste_ar` berördes blott `r konkurser_senaste_antal` anställda av konkurser, vilket var `r ifelse(konkurser_senaste_antal > konkurser_foregaende_ar_antal,"fler","färre")` än de `r konkurser_foregaende_ar_antal` anställda som berördes motsvarande månad `r konkurser_foregaende_ar`.
