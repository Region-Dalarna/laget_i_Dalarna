...
<ul>
<li> Konjunkturinstitutets barometerindikator visar på ett normalt stämningsläget i den svenska ekonomin i `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar`. Stämningsläget bland hushållen är dock svagare än normalt.</li>
<li> Inflationen i `r inflation_senaste_manad_ar` var `r inflation_senaste_varde` procent, vilket är klart lägre än Riksbankens inflationsmål. Riksbankschefen Erik Thedéen varnar dock för att högre drivmedelspriser till följd av kriget i Mellanöstern kan leda till en ökad inflation ([Riksbanken](https://www.riksbank.se/sv/press-och-publicerat/nyheter-och-pressmeddelanden/nyheter/2026/thedeen-buffertar-ska-vara-anvandbara/){target="_blank"}). </li>
<li> Priserna på småhus i Dalarna var något lägre i `r priser_senaste_manad_ar `, jämfört med månaden innan.
<li> Antalet anställda berörda av konkurser i Dalarna minskade svagt i `r konkurser_senaste_manad` `r konkurser_senaste_ar`, jämfört med motsvarande månad året innan. </li>
<li> Arbetslösheten i Dalarna, som är klart under genomsnittet i Sverige, har minskat under inledningen av 2026, jämfört med motsvarande månader åren innan.</li>
...
Konjunkturinstitutet sammanställer på sin [hemsida](https://www.konj.se/publikationer/prognosjamforelse/){target="_blank"} ett urval av aktuella prognoser för bland annat BNP (på helårsbasis). För såväl år 2026 som år 2027 tror en majoritet bland prognosinstituten att aktiviteten i Sveriges ekonomi (BNP) kommer att öka med mellan 2,5 och 3 procent. 
...
### Generellt {-}
I `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar` var barometerindikatorn `r konjukturbarometern_senaste_varde`, vilket var i stort sett oförändrat jämfört med månaden innan. Barometerindikatorn visar på ett normalt stämningsläge i den svenska ekonomin (se [Konjunkturinstitutet](https://www.konj.se/publikationer/konjunkturbarometern/2026-05-28-oforandrat-stamningslage-men-fler-foretag-forvantar-sig-prisokningar-framover/){target="_blank"}). 

Att barometerindikatorn länge hade ett lågt värde kan delvis förklaras av Rysslands invasion av Ukraina och de effekter denna haft på bland annat tillgången på råvaror. Historiskt varierar barometerindikatorn med konjunkturen och större kriser i samhället, såsom finanskrisen 2008/2009 och Coronapandemin 2020/2021, syns tydligt i diagrammet.
...
Hur läget i ekonomin uppfattas varierar beroende på om det är företagen eller hushållen som tillfrågas. Hushållens syn på ekonomin förbättrades något i `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar`, jämfört med månaden innan (en barometerindikator på `r konj_hushall_senaste`), men eftersom indikatorn understiger 100 är stämningsläget bland hushållen sämre än normalt, se [Konjunkturinstitutet](https://www.konj.se/publikationer/konjunkturbarometern/2026-05-28-oforandrat-stamningslage-men-fler-foretag-forvantar-sig-prisokningar-framover/){target="_blank"}. 

Bland branschgrupperna i diagrammet nedan hade `r konj_bransch_positiv` den mest positiva synen på ekonomin i `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar` (en barometerindikator på `r konj_bransch_positiv_varde`), medan företag inom de övriga branschgrupperna uppfattar den ekonomiska utvecklingen som mer normal, se [Konjunkturinstitutet](https://www.konj.se/publikationer/konjunkturbarometern/2026-05-28-oforandrat-stamningslage-men-fler-foretag-forvantar-sig-prisokningar-framover/){target="_blank"}.

Tjänstesektorn drabbades värst under pandemin (mars/april 2020), medan tillverkningsindustrin uppfattade ekonomin som starkare än normalt från slutet av 2020 fram till mitten av 2022.
...
Sedan Riksbankens inflationsmål infördes 1993 har inflationen, mätt som årsförändring i KPIF, legat klart under inflationsmålet på 2 procent under långa perioder. Från sin bottennivå i april 2020 ökade dock inflationen väldigt mycket och var som högst i `r inflation_max_manad_ar`, då den i Sverige uppgick till `r inflation_max_varde` procent. Därefter minskade inflationen avsevärt och var som lägst i september 2024 (1,1 procent). I  `r inflation_senaste_manad_ar` var inflationen `r inflation_senaste_varde` procent, vilket var lägre än månaden innan och även klart lägre än Riksbankens inflationsmål på 2 procent. För en mer ingående förklaring av vad som påverkade inflationstakten i `r inflation_senaste_manad_ar`, se [SCB](https://www.scb.se/hitta-statistik/statistik-efter-amne/priser-och-ekonomiska-tendenser/priser/konsumentprisindex-kpi/pong/statistiknyhet/konsumentprisindex-kpi-april-2026/){target="_blank"}. Riksbankschefen Erik Thedéen varnar dock för att högre drivmedelspriser till följd av kriget i Mellanöstern kan leda till en ökad inflation ([Riksbanken](https://www.riksbank.se/sv/press-och-publicerat/nyheter-och-pressmeddelanden/nyheter/2026/thedeen-buffertar-ska-vara-anvandbara/){target="_blank"}).
...
Priserna på småhus ökade stadigt under en lång period, såväl i Dalarna som i Sverige. Efter toppen i `r priser_max_manad_ar`, då ett småhus i Dalarna kostade ungefär `r priser_max_varde` miljoner kronor, har dock det genomsnittliga priset på småhus i länet minskat avsevärt och en botten nåddes i oktober 2023, när ett småhus i Dalarna kostade strax under 2,1 miljoner kronor i genomsnitt. Den tydliga minskningen kan delvis förklaras av Rysslands invasion av Ukraina, vilken bland annat medförde en kraftigt ökad inflation med efterföljande räntehöjningar, något som påverkar efterfrågan på bostäder. 

Sedan 2023 har priserna på småhus i Dalarna delvis återhämtat sig och var i `r priser_senaste_manad_ar ` knappt `r priser_senaste_varde` miljoner kronor (i genomsnitt). Detta var dock något lägre än månaden innan.
...
### Län {-}
Det genomsnittliga priset på ett småhus varierar mellan Sveriges län och var i `r priser_senaste_manad_ar` högst i `r priser_senaste_max_region`, där ett småhus i genomsnitt kostade `r priser_senaste_max_varde` miljoner kronor. I Dalarna är priset klart lägre, ett småhus kostar i genomsnitt knappt `r priser_senaste_varde` miljoner kronor i länet. Av förklarliga skäl är bostadspriserna generellt högst i län med större städer där befolkningen växer, medan det omvända gäller för län med en mindre befolkning.
...
Antalet anställda som berörs av konkurser varierar relativt mycket från månad till månad, vilket medför att det kan var svårt att se någon trend på månadsbasis kopplad till exempelvis Rysslands invasion av Ukraina och dess effekter på Dalarnas ekonomi. 

Efter att ha ökat tydligt i januari 2025, då närmare 150 personer berördes av konkurser i Dalarna, minskade exempelvis antalet anställda som berördes av konkurser i februari och mars 2025, jämfört med samma period föregående år. Därefter såväl ökade som minskade antalet anställda berörda av konkurser under 2025 jämfört med motvarande månader föregående år, vilket gör det svårt att utröna någon tydlig trend.  

I `r konkurser_senaste_manad` `r konkurser_senaste_ar` berördes `r konkurser_senaste_antal` anställda av konkurser, vilket var `r ifelse(konkurser_senaste_antal > konkurser_foregaende_ar_antal,"fler","färre")` än de `r konkurser_foregaende_ar_antal` anställda som berördes motsvarande månad `r konkurser_foregaende_ar`.
...
Under stora delar av 2025 var arbetslösheten i Dalarna på ungefär samma nivå som motsvarande perioder 2023 och 2024, men mot slutet av året var den något lägre. Denna trend har fortsatt under inledningen av 2026, då arbetslösheten varit lägre än motsvarande månader åren innan.
...
Om arbetslösheten delas upp i inrikes och utrikes födda framträder en delvis annorlunda bild. Bland inrikes födda (det vänstra diagrammet nedan) var arbetslösheten något högre under 2025 jämfört med åren innan under stora delar av året . I `r arbetsloshet_tidsserie_manad` `r arbetsloshet_tidsserie_ar` var arbetslösheten bland inrikes födda `r arbetsloshet_tidserie_Dalarna_inrikes_varde` procent i Dalarna, vilket dock var lägre än motsvarande månad året innan. Bland utrikes födda (det högra diagrammet nedan) har arbetslösheten fortsatt att minska stadigt under samma tidsperiod, men är klart högre än bland inrikes födda (`r arbetsloshet_tidserie_Dalarna_utrikes_varde` procent i `r arbetsloshet_tidsserie_manad` `r arbetsloshet_tidsserie_ar`). 

Totalt var ungefär `r arblosa_inrikes` inrikes födda personer och ca `r arblosa_utrikes` utrikes födda personer i åldersgruppen `r arblosa_alder` arbetslösa i Dalarna i `r arblosa_manad` `r arblosa_ar`.
