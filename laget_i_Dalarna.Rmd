...
```{r, include = FALSE}
   diagram_capt = "Källa: Socialstyrelsen\nBearbetning: Samhällsanalys, Region Dalarna\nDiagramförklaring: Ekonomiskt bistånd är ett stöd som personer kan ansöka om i sin kommun om de har problem att försörja sig själva och sin familj.\nEkonomiskt bistånd består av försörjningsstöd och bistånd till livsföringen i övrigt."
