...
<li> Inflationen i `r inflation_senaste_manad_ar` var lägre än månaderna innan och mer eller mindre i linje med Riksbankens inflationsmål.</li>
...
### Generellt {-}
I `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar` var barometerindikatorn `r konjukturbarometern_senaste_varde`, vilket var marginellt lägre än månaden innan. Eftersom barometerindikatorn överstiger 100 kan läget i Sveriges ekonomi beskrivas som starkare än normalt. Att barometerindikatorn länge hade ett lågt värde kan delvis förklaras av Rysslands invasion av Ukraina och de effekter denna haft på bland annat tillgången på råvaror. Historiskt varierar barometerindikatorn med konjunkturen och större kriser i samhället, såsom finanskrisen 2008/2009 och Coronapandemin 2020/2021, syns tydligt i diagrammet.
...
Intressant att notera är att ekonomin uppfattades som starkare än normalt (ett indikatorvärde över 100) i samtliga branschgrupper i `r konjukturbarometern_senaste_manad` `r konjukturbarometern_senaste_ar` förutom byggindustri. 
...
Sedan Riksbankens inflationsmål infördes 1993 har inflationen, mätt som årsförändring i KPIF, legat klart under inflationsmålet på 2 procent under långa perioder. Från sin bottennivå i april 2020 ökade dock inflationen väldigt mycket och var som högst i `r inflation_max_manad_ar`, då den i Sverige uppgick till `r inflation_max_varde` procent. Därefter minskade inflationen avsevärt och var som lägst i september 2024 (1,1 procent). I  `r inflation_senaste_manad_ar` var inflationen `r inflation_senaste_varde` procent, vilket var lägre än månaderna innan och bara något över Riksbankens inflationsmål på 2 procent. För en mer ingående förklaring av vad som påverkade inflationstakten i `r inflation_senaste_manad_ar`, se [SCB](https://www.scb.se/hitta-statistik/statistik-efter-amne/priser-och-ekonomiska-tendenser/priser/konsumentprisindex-kpi/pong/statistiknyhet/konsumentprisindex-kpi-december-2025/){target="_blank"}. 
...
Under `r konkurser_senaste_ar` berördes `r konkurser_hittils_i_ar` anställda av konkurser i Dalarna, vilket var klart `r ifelse(konkurser_hittils_i_ar > konkurser_motsvarande_foregaende_ar,"fler","färre")` än de `r konkurser_motsvarande_foregaende_ar` som berördes under 2024. En stor del av den skillnaden kan förklaras av att ovanligt många berördes av konkurser i januari 2025.
...
I `r avregistrerade_senaste_manad` `r avregistrerade_senaste_ar` avregistrerades `r avregisterade_senaste_varde` företag i Dalarna, jämfört med `r avregistrerade_foregaende_ar_varde` samma månad året innan. Totalt avregistrerade `r antal_avregistreringar_innevarande_ar` företag under `r avregistrerade_senaste_ar`, att jämföra med `r antal_avregistreringar_motsvarande_foregaende_ar`  företag året innan.
