...
k=1
```
Läget för företagen i länet hänger naturligtvis samman med läget i ekonomin i stort. En indikator på sämre tider är att företag tvingas gå i konkurs, och en annan potentiell indikator är att färre nya företag startas. Dessa undersöker vi i detta avsnitt.
