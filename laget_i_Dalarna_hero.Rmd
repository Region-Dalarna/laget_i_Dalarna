...
k=1
```
Läget för företagen i länet hänger naturligtvis samman med läget i ekonomin i stort. En indikator på sämre tider är att företag tvingas gå i konkurs. En annan potentiellt indikator är att färre nya företag startas, vilket vi också undersöker i detta avsnitt.
