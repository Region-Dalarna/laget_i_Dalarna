...
ekonomiskt_bistand_df <-  read.xlsx(here("Data","Socialstyrelsen_2023_10_09.xlsx"),startRow = 2) %>% 
...
## `r i` Det allmänna läget i ekonomin
```{r, include = FALSE}
k=1
```
...
### `r paste0(i,".",k)` Konjunkturbarometern{.tabset}
```{r, include = FALSE}
k = k+1
```
...
### `r paste0(i,".",k)` Bostadsbyggande{.tabset}
```{r, include = FALSE}
k = k+1
```
...
### `r paste0(i,".",k)` Bostadspriser{.tabset}
```{r, include = FALSE}
k = k+1
i = i+1
```
...
### `r paste0(i,".",k)` Nystartade företag
```{r, include = FALSE}
k = k+1
i = i+1
```
...
### `r paste0(i,".",k)` Arbetslöshet {.tabset}
```{r, include = FALSE}
k = k+1
i = i+1
```
...
ut <- rbind(ekonomiskt_bistand_utskrift %>% select(ar_manad,variabel,antal_hushall),ekonomiskt_bistand_jmf)
  ...
  diagram_titel <- paste0("Antal hushåll med ekonomiskt bistånd i Dalarna, januari 2018 till ",tolower(last(ekonomiskt_bistand_utskrift$Månad))," ",last(ekonomiskt_bistand_utskrift$År))
...
### `r paste0(i,".",k)` Ekonomiskt bistånd
```{r, include = FALSE}
i = i+1
```
